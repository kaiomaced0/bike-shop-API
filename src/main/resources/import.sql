...
-- The commands are coted as their support dependf the database
 ...
 insert into usuario ( login, senha) values( 'amanda', 'cBz32i3RfBAIaqKNkTfdDZLrqih7z94jKllRAMiOW+U+b3GTkGAVUJhWsP6LK8KfVkkei6cekKUJpS2bU7VqvQ==');
 insert into usuario ( login, senha) values( 'isabela', 'cBz32i3RfBAIaqKNkTfdDZLrqih7z94jKllRAMiOW+U+b3GTkGAVUJhWsP6LK8KfVkkei6cekKUJpS2bU7VqvQ==');
 insert into usuario ( login, senha) values( 'gabriel', 'cBz32i3RfBAIaqKNkTfdDZLrqih7z94jKllRAMiOW+U+b3GTkGAVUJhWsP6LK8KfVkkei6cekKUJpS2bU7VqvQ==');
 insert into usuario ( login, senha) values( 'otavio', 'cBz32i3RfBAIaqKNkTfdDZLrqih7z94jKllRAMiOW+U+b3GTkGAVUJhWsP6LK8KfVkkei6cekKUJpS2bU7VqvQ==');
 ...
 insert into itemcompra (id, produto_item_compra, quantidade) values(103, (SELECT produto.id FROM produto WHERE produto.nome = 'bike 5'), 5);
